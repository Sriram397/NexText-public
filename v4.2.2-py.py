...
def frln(n):    # used inside code for beteer spacing
    for i7 in range(n):
        print()
...
def userchoice(cid):
    while True:
        frln(2)
        print('If you want to make a POST ENTER 1')
        print('If you want to VIEW the public page ENTER 2')
        print('If you want to log out and close app ENTER 3')
        e=input('Enter choice(only number):')
        frln(2)
        if e=='1':
            chatwrite(cid)
        if e=='2':
